...
pub fn get_stations_by_name(api: &RadioBrowserAPI, query: &String) -> Result<Vec<ApiStation>, Box<dyn Error>>{
...
pub fn get_presets(api: &RadioBrowserAPI, presets: &[&str]) -> Result<Vec<ApiStation>, Box<dyn std::error::Error>> {
...
pub fn get_stations_by_tag(api: &RadioBrowserAPI, query: &String) -> Result<Vec<ApiStation>, Box<dyn Error>>{
